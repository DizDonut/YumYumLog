...
function initConfig(args) {
  if (!_helpers2.default.config.configFileExists() || !!args.force) {
    ...
    console.log('Created "' + _helpers2.default.config.relativeConfigFile() + '"');
  } else {
    _helpers2.default.init.notifyAboutExistingFile(_helpers2.default.config.relativeConfigFile());
    process.exit(1);
  }
}
